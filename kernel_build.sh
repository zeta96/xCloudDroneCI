...
git clone --depth=1 https://github.com/greenforce-project/clang-llvm -b main clang # set as Clang Default
...
function push() {
    ...
    curl -F document=@$ZIP "https://api.telegram.org/bot$TG_TOKEN/sendDocument" \
        ...
        -F "parse_mode=html" \
        -F caption="Compile took $(($DIFF / 60)) minute(s) and $(($DIFF % 60)) second(s). | For <b>$DEVICE_CODENAME</b> | <b>$DEVICE_CONFIG</b> build | <b>${COMPILER_STRING}</b>"
}
# Fin Error
function finerr() {
